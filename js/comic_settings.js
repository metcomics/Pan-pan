...
const pgData = [
    {
        ...
        title: "O dia que o padeiro comeu o PÃo que o diabo amassou", //the title of the page (leaving this blank will default it to "Page X")
    ...
    {
        pgNum: 4,
        title: "Tudo bem quando termina bem",
